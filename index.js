...
router.get("/", async (req, res) => {
    ...
    const api_all_shoes = "https://shoes-api-rm9c.onrender.com/api/shoes/api/shoes";
    const shoes = (await axios.get(api_all_shoes)).data;

    const api = "https://shoes-api-rm9c.onrender.com/api/shoes/api/shoes/brandnames";
    const brandNames = (await axios.get(api)).data;

    const api_sizes = "https://shoes-api-rm9c.onrender.com/api/shoes/api/shoes/sizes";
    const sizes = (await axios.get(api_sizes)).data;

    const api_colors = "https://shoes-api-rm9c.onrender.com/api/shoes/api/shoes/colors";
...
router.get('/brand/:brand', async (req, res) => {
    ...
    const api_brand = `https://shoes-api-rm9c.onrender.com/api/shoes/api/shoes/brand/${brand}`;
    const shoes = (await axios.get(api_brand)).data;
    const api_brandnames = "https://shoes-api-rm9c.onrender.com/api/shoes/api/shoes/brandnames";
...
router.get('/size/:size', async (req, res) => {
    ...
    const api_size = `https://shoes-api-rm9c.onrender.com/api/shoes/api/shoes/size/${size_}`;
...
router.get('/color/:color', async (req, res) => {
    ...
    const api_size = `https://shoes-api-rm9c.onrender.com/api/shoes/api/shoes/colors/${color_params}`;
    const shoes = (await axios.get(api_size)).data;
...
router.post('/filter', async (req, res) => {
    ...
    const api_brand_size = `https://shoes-api-rm9c.onrender.com/api/shoes/api/shoes/brand/${brand_body}/size/${size_params}`;
...
router.post('/addToCart/:id', async (req, res) => {
    ...
    const addShoeId = `https://shoes-api-rm9c.onrender.com/api/shoes/api/shoes/${shoeId}`;
...
router.get('/cart', async (req, res) => {
    const getCart = 'https://shoes-api-rm9c.onrender.com/api/shoes/api/shoes/cart';
